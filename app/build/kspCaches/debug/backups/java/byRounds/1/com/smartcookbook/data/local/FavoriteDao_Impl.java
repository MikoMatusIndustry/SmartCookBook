...
public final class FavoriteDao_Impl implements FavoriteDao {
  ...
  public FavoriteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFavoriteEntity = new EntityInsertionAdapter<FavoriteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `Ulubione` (`id`,`user_uid`,`przepis_id`) VALUES (nullif(?, 0),?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindLong(3, entity.getRecipeId());
      }
    };
    this.__deletionAdapterOfFavoriteEntity = new EntityDeletionOrUpdateAdapter<FavoriteEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "DELETE FROM `Ulubione` WHERE `id` = ?";
      }
  ...
  public Flow<List<FavoriteEntity>> getAllFavorites() {
    final String _sql = "SELECT * FROM Ulubione";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"Ulubione"}, new Callable<List<FavoriteEntity>>() {
      @Override
      @NonNull
      public List<FavoriteEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfRecipeId = CursorUtil.getColumnIndexOrThrow(_cursor, "przepis_id");
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new FavoriteEntity(_tmpId,_tmpUserUid,_tmpRecipeId);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<Boolean> isFavorite(final int recipeId) {
    final String _sql = "SELECT EXISTS(SELECT 1 FROM Ulubione WHERE przepis_id = ? LIMIT 1)";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, recipeId);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"Ulubione"}, new Callable<Boolean>() {
      @Override
      @NonNull
  ...
  @Override
  public Object getFavorite(final int recipeId,
      final Continuation<? super FavoriteEntity> $completion) {
    final String _sql = "SELECT * FROM Ulubione WHERE przepis_id = ? LIMIT 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindLong(_argIndex, recipeId);
      ...
      public FavoriteEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final int _tmpRecipeId;
            _tmpRecipeId = _cursor.getInt(_cursorIndexOfRecipeId);
            _result = new FavoriteEntity(_tmpId,_tmpUserUid,_tmpRecipeId);
          } else {
            _result = null;
          }
          return _result;
